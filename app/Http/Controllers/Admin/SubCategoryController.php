...
class SubCategoryController extends Controller
{
    ...
    public function insert (Request $request)
    {
        ...
        return redirect('admin/sub_category/list')->with('success',"Sub Category Seccessfully Created");
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('admin/sub_category/list')->with('success',"Sub Category Seccessfully Update");
    ...
    public function delete($id)
    {
        ...
        return redirect()->back()->with('success',"Category Seccessfully Deleted");
